...
const MENU_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        sku: 'jugo-guanabana-12',
        sizeGroup: 'jugo-guanabana',
        nombre: L('Jugo de Guanábana 12oz', 'Soursop Juice 12oz', 'グアナバナジュース 12oz', 'Suco de Graviola 12oz'),
        img: 'img/platos/jugo-guanabana.jpg',
        precio: 600,
      },
      {
        sku: 'jugo-guanabana-16',
        sizeGroup: 'jugo-guanabana',
        nombre: L('Jugo de Guanábana 16oz', 'Soursop Juice 16oz', 'グアナバナジュース 16oz', 'Suco de Graviola 16oz'),
        img: 'img/platos/jugo-guanabana.jpg',
        precio: 700,
      },
      {
        ...
        img: 'img/platos/te-frutos-rojos-frio.jpg',
        precio: 500,
      },
      {
        sku: 'panela-limon',
  ...
  },
  {
    ...
    items: [
      { sku: 'te-frutos-rojos-caliente-8', sizeGroup: 'te-frutos-rojos-caliente', nombre: L('Té Caliente de Frutos Rojos 8oz', 'Hot Berry Tea 8oz', 'ホットベリーティー 8oz', 'Chá Quente de Frutas Vermelhas 8oz'), subt: L('Caliente', 'Hot', 'ホット', 'Quente'), img: 'img/platos/te-frutos-rojos-caliente.jpg', precio: 400 },
      { sku: 'te-frutos-rojos-caliente-12', sizeGroup: 'te-frutos-rojos-caliente', nombre: L('Té Caliente de Frutos Rojos 12oz', 'Hot Berry Tea 12oz', 'ホットベリーティー 12oz', 'Chá Quente de Frutas Vermelhas 12oz'), subt: L('Caliente', 'Hot', 'ホット', 'Quente'), img: 'img/platos/te-frutos-rojos-caliente.jpg', precio: 500 },
      { sku: 'capuccino-8', sizeGroup: 'capuccino', nombre: L('Capuccino 8oz', 'Cappuccino 8oz', 'カプチーノ 8oz', 'Capuccino 8oz'), subt: L('Caliente o frío', 'Hot or iced', 'ホット・アイス', 'Quente ou gelado'), img: 'img/platos/capuccino.jpg', precio: 550 },
      { sku: 'capuccino-12', sizeGroup: 'capuccino', nombre: L('Capuccino 12oz', 'Cappuccino 12oz', 'カプチーノ 12oz', 'Capuccino 12oz'), subt: L('Caliente o frío', 'Hot or iced', 'ホット・アイス', 'Quente ou gelado'), img: 'img/platos/capuccino.jpg', precio: 650 },
      { sku: 'mocha-8', sizeGroup: 'mocha', nombre: L('Mocha 8oz', 'Mocha 8oz', 'モカ 8oz', 'Mocha 8oz'), subt: L('Caliente o frío', 'Hot or iced', 'ホット・アイス', 'Quente ou gelado'), img: 'img/platos/mocha.jpg', precio: 600 },
      { sku: 'mocha-12', sizeGroup: 'mocha', nombre: L('Mocha 12oz', 'Mocha 12oz', 'モカ 12oz', 'Mocha 12oz'), subt: L('Caliente o frío', 'Hot or iced', 'ホット・アイス', 'Quente ou gelado'), img: 'img/platos/mocha.jpg', precio: 700 },
      { sku: 'latte-8', sizeGroup: 'latte', nombre: L('Café Latte 8oz', 'Café Latte 8oz', 'カフェラテ 8oz', 'Café Latte 8oz'), subt: L('Caliente o frío', 'Hot or iced', 'ホット・アイス', 'Quente ou gelado'), img: 'img/platos/latte.jpg', precio: 550 },
      { sku: 'latte-12', sizeGroup: 'latte', nombre: L('Café Latte 12oz', 'Café Latte 12oz', 'カフェラテ 12oz', 'Café Latte 12oz'), subt: L('Caliente o frío', 'Hot or iced', 'ホット・アイス', 'Quente ou gelado'), img: 'img/platos/latte.jpg', precio: 650 },
      { sku: 'tinto-8', sizeGroup: 'tinto', nombre: L('Tinto 8oz', 'Colombian Black Coffee 8oz', 'ティント（コロンビア風ブラックコーヒー）8oz', 'Tinto 8oz'), subt: L('Caliente', 'Hot', 'ホット', 'Quente'), img: 'img/platos/tinto.jpg', precio: 400 },
      { sku: 'tinto-12', sizeGroup: 'tinto', nombre: L('Tinto 12oz', 'Colombian Black Coffee 12oz', 'ティント（コロンビア風ブラックコーヒー）12oz', 'Tinto 12oz'), subt: L('Caliente', 'Hot', 'ホット', 'Quente'), img: 'img/platos/tinto.jpg', precio: 500 },
      { sku: 'americano-8', sizeGroup: 'americano', nombre: L('Americano 8oz', 'Americano 8oz', 'アメリカーノ 8oz', 'Americano 8oz'), subt: L('Caliente', 'Hot', 'ホット', 'Quente'), img: 'img/platos/americano.jpg', precio: 450 },
      { sku: 'americano-12', sizeGroup: 'americano', nombre: L('Americano 12oz', 'Americano 12oz', 'アメリカーノ 12oz', 'Americano 12oz'), subt: L('Caliente', 'Hot', 'ホット', 'Quente'), img: 'img/platos/americano.jpg', precio: 550 },
    ],
    extras: [
